package com.hunting.edison.admin.aspect;
...
import com.hunting.edison.admin.util.SecurityUtils;
import com.hunting.edison.common.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* com.hunting.edison.*.dao.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* com.hunting.edison.*.dao.*.insert*(..))")
